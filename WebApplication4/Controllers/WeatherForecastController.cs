...
namespace WebApplication4.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        {
            "Freezing", "Bracing", "Chilly", "Cool", "Mild", "Warm", "Balmy", "Hot", "Sweltering", "Scorching" ,"Nice cock"
        };
        ...
        List<WeatherForecast> posts = new List<WeatherForecast>();
